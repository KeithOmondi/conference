  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <p className="text-xl text-gray-600 italic">Loading presenter details…</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#0F3B35] text-white">
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-10">
          ...
          <div className="bg-yellow-500/90 text-[#0F3B35] p-6 md:p-10 rounded-xl shadow-xl max-w-3xl">
            ...
            <p className="text-sm md:text-base font-semibold uppercase leading-snug">
              THEME: UPHOLDING HUMAN DIGNITY, ETHICAL LEADERSHIP AS A PILLAR OF CONSTITUTIONALISM
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-10 relative z-10">
            ...
            <div className="flex-1 pt-4 text-center md:text-left">
              ...
              <div className="bg-black/20 p-6 rounded-lg border border-yellow-500/20">
                <h3 className="text-3xl font-bold text-yellow-500 mb-4">Biography</h3>
        ...
        <div className="flex justify-between mt-8">
          {/* Judiciary Logo */}
          <div className="w-28 h-28 md:w-32 md:h-32 flex-shrink-0 overflow-hidden  shadow-lg">
            <img
          ...
          <div className="flex items-center space-x-2 text-lg font-semibold text-yellow-500">
            ...
            <span>highcourt.judiciary.go.ke</span>
          </div>
        </div>
      </div>
    </div>
